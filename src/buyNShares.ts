...
// const fetchFirstMatchingMarketOrder = async (marketId: string, shareType: ShareType): Promise<[number, number]> => {
...
// const main = async () => {
//     const marketId = await getMarketID('in-2028-will-an-ai-be-able-to-gener');
//     await fetchFirstMatchingMarketOrder(marketId, ShareType.yes);
// }
