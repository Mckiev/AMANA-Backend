...
const main = async() => {
  ...
  // const tx = await Railgun.sendTransfer(railgunWalletInfo.id, Railgun.getWallet().getAddress(), 'bet:MP/will-a-large-language-models-beat-a:YES:0zk1qyrydfzxe9sjeqmduhcwhdg4vqzsskx9x8ww7drhpfnt6m6m80e24rv7j6fe3z53l70m3u6jw99re6yqjvjzkgrsu2enr0xn30dwuwu402tg54cwny9yq0sh4xn', 10n);
